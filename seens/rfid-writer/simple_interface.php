            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select id="portSelect" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <?php 
                        // Set default port based on OS and available ports
                        if (PHP_OS === 'WINNT') {
                            $defaultPort = 'COM3';
                        } else {
                            // For macOS/Linux, prefer cu.usbserial devices
                            $defaultPort = '/dev/ttyUSB0';
                            foreach ($availablePorts as $port) {
                                if (strpos($port, 'cu.usbserial') !== false) {
                                    $defaultPort = $port;
                                    break;
                                }
                            }
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <ul class="text-sm text-gray-600 space-y-1">
                        ...
                        <?php else: ?>
                        <li>• macOS: Check /dev/cu.usbserial-* devices</li>
                        <li>• Linux: Check /dev/ttyUSB* or /dev/ttyACM* devices</li>
                        <?php endif; ?>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="text-sm text-gray-600 space-y-1">
                        ...
                        <?php else: ?>
                        <li>• macOS: Usually /dev/cu.usbserial-* or /dev/tty.usbserial-*</li>
