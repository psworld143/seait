...
// Build query for leave requests in the department
$query = "SELECT lr.*, 
          e.first_name, e.last_name, e.employee_id, e.department, e.email,
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-seait-dark">Leave Requests</h1>
                <p class="text-gray-600 mt-1">Manage leave requests for <?php echo htmlspecialchars($head_department); ?> department</p>
            </div>
            <div class="mt-4 sm:mt-0">
                <div class="flex items-center space-x-2">
                    <div class="h-8 w-8 rounded-full bg-seait-orange flex items-center justify-center">
                        <span class="text-white font-medium text-sm"><?php echo strtoupper(substr($head_info['first_name'], 0, 1) . substr($head_info['last_name'], 0, 1)); ?></span>
                    </div>
                    <div>
                        <p class="text-sm font-medium text-gray-900"><?php echo htmlspecialchars($head_info['first_name'] . ' ' . $head_info['last_name']); ?></p>
...
function approveLeave(leaveId) {
    if (confirm('Are you sure you want to approve this leave request?')) {
        fetch('approve-leave-request.php', {
            method: 'POST',
            headers: {
