...
<head>
    ...
    <title>Debug Student Screen</title>
...
<body class="bg-gray-50 p-8">
    <h1 class="text-2xl font-bold mb-6">Debug Student Screen</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="teacher-card bg-white rounded-lg shadow-md p-6 border border-gray-200" 
            ...
            <p class="text-sm text-gray-500 mt-2">Click to test consultation request</p>
        </div>
    ...
    <script>
        ...
        // Check if teacher cards are found
        ...
        teacherCards.forEach((card, index) => {
            ...
            card.addEventListener('click', function() {
                ...
                log('Sending consultation request...');
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        log('Success! Consultation request sent.');
