<?php
// Unified Header for Social Media Portal
// This file provides a consistent header across all social media pages
...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title . ' - Social Media Portal' : 'Social Media Portal'; ?></title>
        ...
        <div class="flex-1 flex flex-col lg:ml-0">
                ...
                <div class="flex justify-between items-center py-4 px-4 sm:px-6 lg:px-8">
                    ...
                    <div>
                            <h1 class="text-lg sm:text-xl font-bold text-seait-dark">
                                <?php echo isset($page_title) ? $page_title : 'Social Media Portal'; ?>
                            </h1>
            ...
            <div class="flex items-center space-x-4">
                        ...
                        <div class="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-seait-orange flex items-center justify-center overflow-hidden">
                            ...
                            error_log("Header Debug - Session profile_photo: " . ($_SESSION['profile_photo'] ?? 'NOT SET'));
