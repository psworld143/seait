...
INSERT IGNORE INTO `semesters` (`name`, `academic_year`, `start_date`, `end_date`, `created_by`) VALUES
...
INSERT IGNORE INTO `subjects` (`code`, `name`, `description`, `units`, `created_by`) VALUES
...
INSERT IGNORE INTO `evaluation_categories` (`name`, `description`, `evaluation_type`, `created_by`) VALUES
...
INSERT IGNORE INTO `evaluation_schedules` (`semester_id`, `evaluation_type`, `start_date`, `end_date`, `created_by`) VALUES
...
CREATE INDEX IF NOT EXISTS `idx_evaluation_sessions_semester_type` ON `evaluation_sessions` (`semester_id`, `evaluation_type`);
...
CREATE INDEX IF NOT EXISTS `idx_teacher_subjects_semester` ON `teacher_subjects` (`semester_id`, `status`);
CREATE INDEX IF NOT EXISTS `idx_student_enrollments_status` ON `student_enrollments` (`status`);
CREATE INDEX IF NOT EXISTS `idx_evaluation_schedules_active` ON `evaluation_schedules` (`status`, `start_date`, `end_date`);
