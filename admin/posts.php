...
// Fetch all posts into an array to avoid result set pointer issues
$posts_array = [];
        ...
        <div class="flex-1 ml-64 p-8 overflow-y-auto h-screen">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900">Posts (<?php echo $total_posts; ?> total)</h2>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            ?>
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4">
                                        <div>
                                            <div class="text-sm font-medium text-gray-900"><?php echo htmlspecialchars($post['title'] ?? 'No Title'); ?></div>
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-900">
                                        ...
                                        <div class="text-xs text-gray-500">@<?php echo htmlspecialchars($post['username'] ?? 'unknown'); ?></div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full
                                            ...
                                            ?>">
                                            <?php echo ucfirst($post['type'] ?? 'unknown'); ?>
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full
                                            ...
                                            ?>">
                                            <?php echo ucfirst($post['status'] ?? 'unknown'); ?>
                                        </span>
                                    </td>
