    ...
    <?php include 'includes/admin-header.php'; ?>
            ...
            <div class="mt-8 bg-white rounded-lg shadow-md p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <a href="export_reports.php?type=users&semester=<?php echo $selected_semester; ?>&year=<?php echo $selected_year; ?>"
                    ...
                    <a href="export_reports.php?type=posts&semester=<?php echo $selected_semester; ?>&year=<?php echo $selected_year; ?>"
                       class="flex items-center justify-center p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                        <i class="fas fa-newspaper text-green-600 mr-3"></i>
                        <span>Export Post Report</span>
                    </a>
                    <a href="export_reports.php?type=inquiries&semester=<?php echo $selected_semester; ?>&year=<?php echo $selected_year; ?>"
                       class="flex items-center justify-center p-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                        <i class="fas fa-comments text-orange-600 mr-3"></i>
                        <span>Export Inquiry Report</span>
                    </a>
                </div>
            </div>
