<?php
// Unified Header for Admin Portal
...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title . ' - Admin Portal' : 'Admin Portal'; ?></title>
                ...
                <div class="flex justify-between items-center py-4 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-seait-orange flex items-center justify-center overflow-hidden">
                            ...
                            error_log("Admin Header Debug - Session profile_photo: " . ($_SESSION['profile_photo'] ?? 'NOT SET'));
                            error_log("Admin Header Debug - Session user_id: " . ($_SESSION['user_id'] ?? 'NOT SET'));
