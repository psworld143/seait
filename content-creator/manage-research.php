    ...
    if (isset($_POST['action'])) {
        if ($_POST['action'] === 'add_category') {
            ...
            $query = "INSERT INTO publications (title, abstract, research_category_id, publication_date, journal_name, doi_link, research_link, keywords, status, featured, sort_order, is_active, created_by)
                     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            $stmt = mysqli_prepare($conn, $query);
            mysqli_stmt_bind_param($stmt, 'ssissssssiiss', $title, $abstract, $research_category_id, $publication_date, $journal_name, $doi_link, $research_link, $keywords, $status, $featured, $sort_order, $is_active, $_SESSION['user_id']);
            ...
            if (isset($_FILES['author_photo_file']) && $_FILES['author_photo_file']['error'] === UPLOAD_ERR_OK) {
                ...
                if (!is_writable($upload_dir)) {
                    ...
                    $file_info = pathinfo($_FILES['author_photo_file']['name']);
                    ...
                    if (in_array($file_extension, $allowed_extensions)) {
                        ...
                        if (move_uploaded_file($_FILES['author_photo_file']['tmp_name'], $filepath)) {
                            $author_photo_url = '../uploads/authors/' . $filename;
                        } else {
                            error_log("Failed to move uploaded file from " . $_FILES['author_photo_file']['tmp_name'] . " to " . $filepath);
...
$current_page = 'manage-research.php';
...
?>
                ...
                <?php elseif ($active_tab === 'authors'): ?>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <button onclick="addAuthor()" class="bg-seait-orange text-white px-4 py-2 rounded hover:bg-orange-600 transition">
                ...
                <form method="POST" action="">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="title" required class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="abstract" rows="4" required class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select name="research_category_id" required class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="date" name="publication_date" required class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="journal_name" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="url" name="doi_link" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="url" name="research_link" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="keywords" placeholder="keyword1, keyword2, keyword3" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select name="status" required class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="sort_order" value="0" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                            </div>
                        </div>
                    </div>
                ...
                <form method="POST" action="">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="title" id="edit_publication_title" required class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="abstract" id="edit_publication_abstract" rows="4" required class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select name="research_category_id" id="edit_publication_category" required class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                                    <option value="">Select Category</option>
                                    <?php
                                    mysqli_data_seek($categories_result, 0);
                                    while($cat = mysqli_fetch_assoc($categories_result)):
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="date" name="publication_date" id="edit_publication_date" required class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="journal_name" id="edit_publication_journal" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="url" name="doi_link" id="edit_publication_doi" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="url" name="research_link" id="edit_publication_research_link" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="keywords" id="edit_publication_keywords" placeholder="keyword1, keyword2, keyword3" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <select name="status" id="edit_publication_status" required class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                                    <option value="published">Published</option>
                                    <option value="in_progress">In Progress</option>
                                    <option value="submitted">Submitted</option>
                                </select>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="sort_order" id="edit_publication_sort_order" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                            </div>
                        </div>
                    </div>
    ...
    <div id="addAuthorModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-10 mx-auto p-6 border w-11/12 max-w-4xl shadow-lg rounded-md bg-white">
            <div class="mt-3">
                <h3 class="text-xl font-medium text-gray-900 mb-6">Add Author</h3>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            <div class="mb-4">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <input type="file" name="author_photo_file" accept="image/*" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange">
                                    ...
                                    <div id="photoPreview" class="hidden">
                                        ...
                                        <div class="w-24 h-24 border-2 border-gray-300 rounded-full overflow-hidden bg-gray-100 flex items-center justify-center">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="author_bio" rows="6" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange"></textarea>
                            </div>
                        </div>
                    </div>

                    <div class="flex justify-end space-x-3 mt-6 pt-4 border-t border-gray-200">
                        <button type="button" onclick="closeModal('addAuthorModal')" class="px-6 py-2 text-gray-600 border border-gray-300 rounded-md hover:bg-gray-50">
                            Cancel
                        </button>
                        <button type="submit" class="px-6 py-2 bg-seait-orange text-white rounded-md hover:bg-orange-600">
                            Add Author
                        </button>
                    </div>
                </form>
    ...
    <div id="editAuthorModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
        <div class="relative top-10 mx-auto p-6 border w-11/12 max-w-4xl shadow-lg rounded-md bg-white">
            <div class="mt-3">
                <h3 class="text-xl font-medium text-gray-900 mb-6">Edit Author</h3>
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="mb-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Bio</label>
                                <textarea name="author_bio" id="edit_author_bio" rows="6" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-seait-orange"></textarea>
                            </div>
                        </div>
                    </div>

                    <div class="flex justify-end space-x-3 mt-6 pt-4 border-t border-gray-200">
                        <button type="button" onclick="closeModal('editAuthorModal')" class="px-6 py-2 text-gray-600 border border-gray-300 rounded-md hover:bg-gray-50">
                            Cancel
                        </button>
                        <button type="submit" class="px-6 py-2 bg-seait-orange text-white rounded-md hover:bg-orange-600">
                            Update Author
    ...
    <script>
        ...
        // JavaScript version of generateAuthorInitials function
        function generateAuthorInitials(authorName) {
        ...
        // Author functions
        function addAuthor() {
            // Clear photo preview when opening modal
            ...
            // Clear file input
            const addPhotoFile = document.querySelector('#addAuthorModal input[name="author_photo_file"]');
            if (addPhotoFile) {
                addPhotoFile.value = '';
            }

            // Clear URL input
            const addPhotoUrl = document.querySelector('#addAuthorModal input[name="author_photo_url"]');
            if (addPhotoUrl) {
                addPhotoUrl.value = '';
            }
        ...
        function editAuthor(author) {
            ...
            const publicationIdField = document.getElementById('edit_author_publication_id');
            const authorNameField = document.getElementById('edit_author_name');
            const authorTitleField = document.getElementById('edit_author_title');
            const authorDepartmentField = document.getElementById('edit_author_department');
            const authorEmailField = document.getElementById('edit_author_email');
            const authorBioField = document.getElementById('edit_author_bio');
            const authorIsPrimaryField = document.getElementById('edit_author_is_primary');
            const authorSortOrderField = document.getElementById('edit_author_sort_order');

            if (authorIdField) authorIdField.value = author.id;
            if (publicationIdField) publicationIdField.value = author.publication_id;
            if (authorNameField) authorNameField.value = author.author_name;
            if (authorTitleField) authorTitleField.value = author.author_title;
            if (authorDepartmentField) authorDepartmentField.value = author.author_department;
            if (authorEmailField) authorEmailField.value = author.author_email;
            if (authorBioField) authorBioField.value = author.author_bio;
            if (authorIsPrimaryField) authorIsPrimaryField.checked = author.is_primary_author == 1;
            if (authorSortOrderField) authorSortOrderField.value = author.sort_order;

            // Handle current photo display
            const currentPhoto = document.getElementById('editCurrentPhoto');
            const currentPhotoInitials = document.getElementById('editCurrentPhotoInitials');

            if (currentPhoto && currentPhotoInitials) {
                if (author.author_photo_url) {
                    currentPhoto.src = author.author_photo_url;
                    currentPhoto.dataset.originalSrc = author.author_photo_url; // Store original source
                    currentPhoto.style.display = 'block';
                    currentPhotoInitials.style.display = 'none';
                } else {
                    currentPhoto.style.display = 'none';
                    currentPhotoInitials.style.display = 'flex';
                    currentPhotoInitials.textContent = generateAuthorInitials(author.author_name);
                }
            }
            ...
            // Clear file input
            const editPhotoFile = document.querySelector('#editAuthorModal input[name="author_photo_file"]');
            if (editPhotoFile) {
                editPhotoFile.value = '';
            }
        ...
        function setupPhotoPreview() {
            ...
            // Add Author Modal photo preview
            const addPhotoFile = document.querySelector('#addAuthorModal input[name="author_photo_file"]');
            const addPreview = document.getElementById('photoPreview');
            const addPreviewImage = document.getElementById('previewImage');

            console.log('Add modal elements:', { addPhotoFile, addPreview, addPreviewImage });

            if (addPhotoFile) {
                addPhotoFile.addEventListener('change', function(e) {
            ...
            // Edit Author Modal photo preview
            const editPhotoFile = document.querySelector('#editAuthorModal input[name="author_photo_file"]');
            const editPreview = document.getElementById('editPhotoPreview');
            const editPreviewImage = document.getElementById('editPreviewImage');
            const editCurrentPhoto = document.getElementById('editCurrentPhoto');
            const editCurrentPhotoInitials = document.getElementById('editCurrentPhotoInitials');

            console.log('Edit modal elements:', { editPhotoFile, editPreview, editPreviewImage, editCurrentPhoto, editCurrentPhotoInitials });

            if (editPhotoFile) {
                editPhotoFile.addEventListener('change', function(e) {
                    console.log('Edit file selected:', e.target.files[0]);
                    const file = e.target.files[0];
                    if (file) {
                        const reader = new FileReader();
                        reader.onload = function(e) {
                            console.log('Edit file loaded, updating preview and current photo');
                            // Update preview
                            editPreviewImage.src = e.target.result;
                            editPreview.classList.remove('hidden');

                            // Update current photo display
                            editCurrentPhoto.src = e.target.result;
                            editCurrentPhoto.style.display = 'block';
                            editCurrentPhotoInitials.style.display = 'none';
                        };
                        reader.readAsDataURL(file);
                    } else {
                        editPreview.classList.add('hidden');
        ...
        setupPhotoPreview();
        console.log('Photo preview setup completed');
    </script>
                </div>
            </main>
        </div>
