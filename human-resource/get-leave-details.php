...
if ($table === 'employee') {
    ...
    // Try faculty leave requests table
    $faculty_query = "SELECT flr.*, 
                      f.first_name, f.last_name, f.id as employee_id, f.department, f.email,
                      lt.name as leave_type_name, lt.description as leave_type_description,
                      dh.first_name as head_first_name, dh.last_name as head_last_name,
                      hr.first_name as hr_first_name, hr.last_name as hr_last_name,
...
<div class="space-y-6">
    ...
    <div class="bg-gray-50 rounded-lg p-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <?php if ($leave['source_table'] === 'employee'): ?>
            <div>
                <p class="text-sm font-medium text-gray-600">Phone</p>
                <p class="text-sm text-gray-900"><?php echo htmlspecialchars($leave['phone'] ?? ''); ?></p>
            </div>
            <?php endif; ?>
            <div>
                <p class="text-sm font-medium text-gray-600">Type</p>
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo $leave['source_table'] === 'faculty' ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800'; ?>">
