...
echo "<h1>Populating Faculty Details (Simple Version)</h1>";
...
// Insert details for each faculty member using direct SQL
$success_count = 0;
$error_count = 0;
...
foreach ($faculty_members as $index => $faculty) {
    ...
    $religion = mysqli_real_escape_string($conn, $data['religion']);
    ...
    $date_of_hire = mysqli_real_escape_string($conn, $data['date_of_hire']);
    $employment_type = mysqli_real_escape_string($conn, $data['employment_type']);
    $basic_salary = (float)$data['basic_salary'];
    $salary_grade = mysqli_real_escape_string($conn, $data['salary_grade']);
    $allowances = (float)$data['allowances'];
    $pay_schedule = mysqli_real_escape_string($conn, $data['pay_schedule']);
    $highest_education = mysqli_real_escape_string($conn, $data['highest_education']);
    $field_of_study = mysqli_real_escape_string($conn, $data['field_of_study']);
    $school_university = mysqli_real_escape_string($conn, $data['school_university']);
    $year_graduated = (int)$data['year_graduated'];
    $tin_number = mysqli_real_escape_string($conn, $data['tin_number']);
    $sss_number = mysqli_real_escape_string($conn, $data['sss_number']);
    $philhealth_number = mysqli_real_escape_string($conn, $data['philhealth_number']);
    $pagibig_number = mysqli_real_escape_string($conn, $data['pagibig_number']);
    ...
    $insert_query = "INSERT INTO faculty_details (
        ...
        '$employee_id', '$date_of_hire', '$employment_type', $basic_salary, '$salary_grade', $allowances, '$pay_schedule',
        '$highest_education', '$field_of_study', '$school_university', $year_graduated,
        '$tin_number', '$sss_number', '$philhealth_number', '$pagibig_number', NOW()
    )";
