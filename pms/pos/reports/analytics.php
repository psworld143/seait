        ...
        <div class="flex-1 lg:ml-64">
            <div class="main-content p-6">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-gray-600">Manage reports operations and data</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow">
                    <div class="p-4 border-b border-gray-200 flex justify-between items-center">
                        <h3 class="text-lg font-semibold text-gray-800">Analytics Dashboard Overview</h3>
                    ...
                    <div class="p-6">
                        <div class="text-center text-gray-500 py-12">
                            ...
                            <p class="text-gray-600">This reports module is currently being developed.</p>
