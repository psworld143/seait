    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 lg:ml-64">
            <div class="main-content p-6">
                <!-- Page Header -->
                <div class="mb-6">
                    <h1 class="text-2xl font-bold text-gray-800 mb-2">Event Services</h1>
                    <p class="text-gray-600">Manage events operations and data</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow">
                    ...
                    <div class="p-6">
                        <div class="text-center text-gray-500 py-12">
                            ...
                            <p class="text-gray-600">This events module is currently being developed.</p>
