...
-- Additional Sample Data for Different Course
INSERT INTO `class_syllabus` (`id`, `class_id`, `teacher_id`, `title`, `description`, `course_objectives`, `learning_outcomes`, `prerequisites`, `course_requirements`, `grading_system`, `course_policies`, `academic_integrity`, `attendance_policy`, `late_submission_policy`, `office_hours`, `contact_information`, `textbooks`, `references`, `schedule`, `assessment_methods`, `course_units`, `course_credits`, `semester`, `academic_year`, `class_schedule`, `classroom_location`, `course_website`, `emergency_contact`, `disability_accommodations`, `is_published`, `published_at`, `created_at`, `updated_at`) VALUES
(2, 2, 1, 'Database Management Systems', 'This course covers fundamental concepts of database design, SQL programming, and database management systems.', 'By the end of this course, students will be able to:\n• Design and implement relational databases\n• Write complex SQL queries\n• Understand database normalization\n• Manage database security and performance', 'Upon completion of this course, students will be able to:\n• Create and modify database schemas\n• Write efficient SQL queries\n• Apply normalization techniques\n• Implement database security measures', 'Basic programming knowledge, understanding of data structures', 'Database software (MySQL/PostgreSQL), laptop computer', 'Assignments: 40%\nMidterm Exam: 25%\nFinal Project: 25%\nParticipation: 10%', 'Regular attendance required, active participation expected', 'All work must be original. Academic dishonesty will not be tolerated.', 'Attendance is mandatory for all sessions.', 'Late submissions accepted with 15% penalty per day.', 'Tuesday and Thursday 1:00-2:00 PM, Room 205', 'Email: dbprofessor@university.edu\nPhone: (555) 123-4568', 'Database Systems: The Complete Book by Garcia-Molina', 'Online SQL tutorials and database documentation', 'Week 1-2: Introduction to Databases\nWeek 3-4: Relational Model\nWeek 5-6: SQL Basics\nWeek 7-8: Advanced SQL\nWeek 9-10: Database Design\nWeek 11-12: Normalization\nWeek 13-14: Database Security\nWeek 15-16: Final Project', 'SQL assignments, database design projects, exams', '3', '3', 'First Semester', '2024-2025', 'Tuesday and Thursday 9:00-10:30 AM', 'Room 102, Computer Science Building', 'https://canvas.university.edu/courses/12346', 'For emergencies during class, contact campus security at (555) 999-1111', 'Students with disabilities should contact the Office of Disability Services for accommodations.', 1, '2024-08-15 11:00:00', '2024-08-15 11:00:00', '2024-08-15 11:00:00');

-- Additional PEOs for Database Course
INSERT INTO `syllabus_peos` (`id`, `syllabus_id`, `peo_code`, `peo_description`, `aligned_to_mission`, `order_number`, `created_at`, `updated_at`) VALUES
(5, 2, 'PEO1', 'Graduates will demonstrate expertise in database design and management, applying their skills to develop efficient data solutions.', 1, 1, '2024-08-15 11:00:00', '2024-08-15 11:00:00'),
(6, 2, 'PEO2', 'Graduates will exhibit strong analytical and problem-solving skills in database development and optimization.', 1, 2, '2024-08-15 11:00:00', '2024-08-15 11:00:00'),
(7, 2, 'PEO3', 'Graduates will demonstrate ethical responsibility in data management and privacy protection.', 1, 3, '2024-08-15 11:00:00', '2024-08-15 11:00:00');

-- Additional CLOs for Database Course
INSERT INTO `syllabus_clos` (`id`, `syllabus_id`, `clo_code`, `clo_description`, `order_number`, `created_at`, `updated_at`) VALUES
(7, 2, 'CLO1', 'Design and implement relational database schemas using proper normalization techniques.', 1, '2024-08-15 11:00:00', '2024-08-15 11:00:00'),
(8, 2, 'CLO2', 'Write and optimize complex SQL queries for data retrieval and manipulation.', 2, '2024-08-15 11:00:00', '2024-08-15 11:00:00'),
(9, 2, 'CLO3', 'Implement database security measures and access control mechanisms.', 3, '2024-08-15 11:00:00', '2024-08-15 11:00:00'),
(10, 2, 'CLO4', 'Analyze and optimize database performance using indexing and query optimization techniques.', 4, '2024-08-15 11:00:00', '2024-08-15 11:00:00');

-- Additional Topics for Database Course
INSERT INTO `syllabus_topics` (`id`, `syllabus_id`, `week_number`, `order_number`, `topic_title`, `description`, `learning_objectives`, `materials`, `references_field`, `activities`, `assessment`, `values_integration`, `target`, `created_at`, `updated_at`) VALUES
(9, 2, 1, 1, 'Introduction to Database Systems', 'Overview of database management systems, types of databases, and their applications in modern computing.', '• Understand the role of databases in information systems\n• Learn about different types of database systems\n• Explore database applications in various industries\n• Set up a database development environment', 'MySQL/PostgreSQL, database management tools, course textbook', 'Garcia-Molina, H. (2008). Database Systems: The Complete Book. Pearson.\nMySQL Documentation: https://dev.mysql.com/doc/\nPostgreSQL Documentation: https://www.postgresql.org/docs/', 'Interactive lecture, database system exploration, hands-on setup', 'Database environment setup (10 points)\nDatabase concepts quiz (15 points)', 'Understanding the importance of data integrity and accuracy in information systems.', 'Students will understand fundamental database concepts and set up their development environment.', '2024-08-15 11:00:00', '2024-08-15 11:00:00'),
(10, 2, 2, 2, 'Relational Data Model', 'Understanding the relational model, entities, relationships, and the mathematical foundation of relational databases.', '• Understand the relational data model\n• Learn about entities, attributes, and relationships\n• Explore relational algebra operations\n• Apply relational model concepts to real-world scenarios', 'Database software, course textbook, relational model examples', 'Garcia-Molina, H. (2008). Database Systems: The Complete Book. Pearson.\nRelational Model: https://en.wikipedia.org/wiki/Relational_model', 'Relational model exercises, entity-relationship analysis, mathematical operations', 'Relational model assignment (20 points)\nRelational algebra quiz (15 points)', 'Logical thinking and mathematical reasoning in data modeling.', 'Students will demonstrate understanding of the relational model and its mathematical foundations.', '2024-08-15 11:00:00', '2024-08-15 11:00:00');

-- Additional Topic-CLO Alignments for Database Course
INSERT INTO `syllabus_topic_clo_alignment` (`id`, `syllabus_id`, `topic_id`, `clo_id`, `is_aligned`, `created_at`) VALUES
(17, 2, 9, 7, 1, '2024-08-15 11:00:00'),
(18, 2, 10, 7, 1, '2024-08-15 11:00:00'),
(19, 2, 10, 8, 1, '2024-08-15 11:00:00');
