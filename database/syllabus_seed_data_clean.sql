-- Syllabus Seed Data (Clean Version)
...
-- Clear existing data to avoid conflicts (optional - comment out if you want to keep existing data)
-- DELETE FROM syllabus_topic_clo_alignment;
-- DELETE FROM syllabus_clo_po_alignment;
-- DELETE FROM syllabus_peo_po_alignment;
-- DELETE FROM syllabus_topics;
-- DELETE FROM syllabus_clos;
-- DELETE FROM syllabus_pos;
-- DELETE FROM syllabus_peos;
-- DELETE FROM syllabus_files;
-- DELETE FROM class_syllabus;
