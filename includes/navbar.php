    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-auto overflow-hidden relative">
        ...
        <div class="p-6">
            <form id="loginForm" method="POST" class="space-y-5">
                <div>
                    <label for="username" class="block text-sm font-medium text-gray-700 mb-1">Username, Email, or QR Code</label>
                    <input type="text" id="username" name="username" required
                           ...
                           placeholder="Enter username, email, or QR code (e.g., 2025-0001)" autocomplete="username">
                    <p class="text-xs text-gray-500 mt-1">Faculty can login using their QR code (e.g., 2025-0001)</p>
                </div>
